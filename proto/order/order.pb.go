...
const (
	...
	OrderStatus_ORDER_STATUS_ON_THE_WAY OrderStatus = 8
)
...
type Order struct {
	...
	PickupAddress        string                 `protobuf:"bytes,17,opt,name=pickup_address,json=pickupAddress,proto3" json:"pickup_address,omitempty"`
	PickupLatitude       float64                `protobuf:"fixed64,18,opt,name=pickup_latitude,json=pickupLatitude,proto3" json:"pickup_latitude,omitempty"`
	PickupLongitude      float64                `protobuf:"fixed64,19,opt,name=pickup_longitude,json=pickupLongitude,proto3" json:"pickup_longitude,omitempty"`
	DestinationLatitude  float64                `protobuf:"fixed64,20,opt,name=destination_latitude,json=destinationLatitude,proto3" json:"destination_latitude,omitempty"`
	DestinationLongitude float64                `protobuf:"fixed64,21,opt,name=destination_longitude,json=destinationLongitude,proto3" json:"destination_longitude,omitempty"`
...
func (x *Order) GetPickupAddress() string {
	if x != nil {
...
func (x *Order) GetDestinationLatitude() float64 {
	if x != nil {
...
func (x *Order) GetDestinationLongitude() float64 {
	if x != nil {
...
type ListOrdersRequest struct {
	...
	Statuses      []OrderStatus             `protobuf:"varint,6,rep,packed,name=statuses,proto3,enum=order.OrderStatus" json:"statuses,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proto_order_order_proto_rawDesc = "" +
	"\n" +
	"\x17proto/order/order.proto\x12\x05order\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x19proto/common/common.proto\"\xb3\x06\n" +
	"\x05Order\x12\x0e\n" +
	...
	"\x0epickup_address\x18\x11 \x01(\tR\rpickupAddress\x12'\n" +
	"\x0fpickup_latitude\x18\x12 \x01(\x01R\x0epickupLatitude\x12)\n" +
	"\x10pickup_longitude\x18\x13 \x01(\x01R\x0fpickupLongitude\x121\n" +
	"\x14destination_latitude\x18\x14 \x01(\x01R\x13destinationLatitude\x123\n" +
	"\x15destination_longitude\x18\x15 \x01(\x01R\x14destinationLongitude\"\xb8\x01\n" +
	"\tOrderItem\x12\x0e\n" +
	...
	"\bstatuses\x18\x06 \x03(\x0e2\x12.order.OrderStatusR\bstatuses\"r\n" +
	...
	"\x16ORDER_STATUS_CANCELLED\x10\a\x12\x1b\n" +
	"\x17ORDER_STATUS_ON_THE_WAY\x10\b2\xef\x02\n" +
	"\fOrderService\x126\n" +
	...
	"\vCancelOrder\x12\x19.order.CancelOrderRequest\x1a\f.order.Order\x126\n" +
	"\vAcceptOrder\x12\x19.order.AcceptOrderRequest\x1a\f.order.OrderB0Z.github.com/mendmzury/food-delivery/proto/orderb\x06proto3"
...
var file_proto_order_order_proto_goTypes = []any{
	...
	(*AcceptOrderRequest)(nil),       // 10: order.AcceptOrderRequest
	(*timestamppb.Timestamp)(nil),    // 11: google.protobuf.Timestamp
	(*common.PaginationRequest)(nil), // 12: common.PaginationRequest
	(*common.PaginationMeta)(nil),    // 13: common.PaginationMeta
}
var file_proto_order_order_proto_depIdxs = []int32{
	...
	12, // 5: order.ListOrdersRequest.pagination:type_name -> common.PaginationRequest
	0,  // 6: order.ListOrdersRequest.status:type_name -> order.OrderStatus
	0,  // 7: order.ListOrdersRequest.statuses:type_name -> order.OrderStatus
	1,  // 8: order.ListOrdersResponse.orders:type_name -> order.Order
	13, // 9: order.ListOrdersResponse.pagination:type_name -> common.PaginationMeta
	...
	10, // 16: order.OrderService.AcceptOrder:input_type -> order.AcceptOrderRequest
	1,  // 17: order.OrderService.CreateOrder:output_type -> order.Order
	1,  // 18: order.OrderService.GetOrder:output_type -> order.Order
	7,  // 19: order.OrderService.ListOrders:output_type -> order.ListOrdersResponse
	1,  // 20: order.OrderService.UpdateOrderStatus:output_type -> order.Order
	1,  // 21: order.OrderService.CancelOrder:output_type -> order.Order
	1,  // 22: order.OrderService.AcceptOrder:output_type -> order.Order
